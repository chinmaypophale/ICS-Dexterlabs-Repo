...
<div id="wrapper">
	<div id="header-wrapper">
           ...
           <h3>Welcome
			...
			<div id="menu">
				<ul>
					...
					<li><a href="#featured1-content">Services</a></li>
					<li><a href="#sidebar">Portfolio</a></li>
					<li><a href="#footer-content-wrapper">Contact</a></li>
		...
		<div id="banner">
			<div class="content"><img src="images/banner.jpg" width="1000" height="400" alt="" /></div>
		</div>
	</div>
	<!-- end #header -->
